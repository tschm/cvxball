...
Hearn~\cite{elzinga1972} gave an early finite algorithm of this type.
Welzl's randomised incremental method~\cite{welzl1991} is expected $O(n)$ for
fixed $d$ but degrades in $d$; G\"artner~\cite{gaertner1999} made it robust, and
Fischer, G\"artner and Kutz~\cite{fischer2003} developed the support-set
framework the method above belongs to, including the balls-of-balls
generalisation. The QP machinery is standard~\cite{nocedal2006}. An
