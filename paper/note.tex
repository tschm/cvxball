...
whereas here they \emph{are} the search --- an asymmetry that also makes a
support set a natural warm start for a perturbed cloud, which a recursion over a
fresh random permutation has no way to accept.
